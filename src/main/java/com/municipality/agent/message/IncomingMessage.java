 ...
 *
 * <p>Every rule is one {@code if} and one {@code throw}, and every rejection is an
 * {@link IllegalArgumentException} — missing and unusable get the same answer. The
 * point is that a reader scans one shape down the constructor instead of three.
 *
